...
- 37 款 iPhone，覆盖 iPhone 8、X、XR、XS/XS Max 至当前主流机型。
- 18 款 iPad，覆盖标准版、mini、Air 和 Pro。
- 9 款 MacBook Air，覆盖 M1 至 M5 的 13/15 英寸代表配置。
- 16 款 MacBook Pro 代表配置。
- iPad 容量与 Wi-Fi / 蜂窝网络联动。
- iPhone 与 iPad 容量跟随机型联动。
...
- 缺少特定容量样本时，二手价格按容量残值换算；官方新机价格使用容量和网络版本价差单独计算。
